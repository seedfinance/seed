...
module.exports.LiquidityStorageDeploy = async function(adminStorage, swapStorage) {
...
module.exports.LPBuilderDeploy = async function(adminStorage, liquidityStore, factory, pair) {
...
module.exports.CustomStorageDeploy = async function(adminStorage,tokenReward,pool,pid,pair,factory) {
    const CustomStorage = await ethers.getContractFactory("CustomStorage")
    const customStorage = await CustomStorage.deploy()
    await customStorage.deployed()
    await customStorage.initializeInvestment(adminStorage,tokenReward,pool,pid,pair,factory)
